...
BASE_URL = "https://services5.arcgis.com/F6GVRyx2cmmxgZzd/arcgis/rest/services/Surrey_Online/FeatureServer/2/query"
...
# Save to file
with open("Surrey_Existing_Divisions.geojson", "w", encoding="utf-8") as f:
