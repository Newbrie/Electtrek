...
ELECTOR_FILE = os.path.join(workdirectories['workdir'],'static','registers','allelectors.csv')
TREKNODE_FILE = os.path.join(workdirectories['workdir'],'static','nodes','Treknodes.json')
